...
from src.agents.agent import ChatAgent
...
piper_model = "/home/andrew/Projects/local_models/piper/en-us-ryan-high.onnx"
tts = PiperTTS(
    model_path=piper_model,
    use_cuda=True,           # use CPU for Piper if CUDA issues
    speed=1.0,
)
