...
class WhisperMLX(stt.STT):
    """
    Whisper Large v3 Turbo ASR FP16 STT plugin using MLX Audio.

    Args:
        model: The model to use.
            Options: "mlx-community/whisper-large-v3-turbo-asr-fp16"
            Recommended: "mlx-community/whisper-large-v3-turbo-asr-fp16"
    """
    ...
    async def _recognize_impl(
        ...
        *,
        ...
        with tempfile.NamedTemporaryFile(suffix=".wav") as tmp:
            ...
            result = self._model.generate_transcription(
                model=self._model,
                audio=audio_data,
                format="txt",
                verbose=True,
